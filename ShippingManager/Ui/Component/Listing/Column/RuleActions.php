<?php
/**
 * Shipping Rule Actions UI Component.
 *
 * @category   RCubed
...
class RuleActions extends Column
{
     ...
     * Url path
     */
    const URL_PATH_EDIT = 'rcubed_shippingmanager/rule/edit';
    const URL_PATH_DELETE = 'rcubed_shippingmanager/rule/delete';
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __('Are you sure you want to delete the "${ $.$data.name }" shipping rule?')
                            ]
                        ]
                    ];
                }
